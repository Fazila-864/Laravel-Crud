            ...
            <form id="productForm" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        <input type="text" id="productName" placeholder="Enter product name" required name="name">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        <input type="number" id="productPrice" placeholder="Enter price" min="0" step="0.01" required name="price">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        <input id="productDescription" placeholder="Enter product description" required name="description">
